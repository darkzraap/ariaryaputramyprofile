...
<div class="container mx-auto px-4 py-12">
    <form action="{{ route('admin.certificate.store') }}" enctype="multipart/form-data" method="POST"
        class="space-y-12">
        @csrf
        ...
        <section class="bg-gray-800 p-8 md:p-12 rounded-2xl shadow-2xl space-y-8">
            ...
            <div class="flex flex-col justify-center gap-5">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" id="credent" name="credent" value="{{ old('tagline') }}"
                        class="w-full bg-gray-700 text-white border border-gray-600 rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-purple-500 transition duration-300 placeholder-gray-400"
                        placeholder="#k44kc...">
                    @error('tagline')
                        <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                 ...
                 <div class="flex flex-col">
                    ...
                    <input type="text" id="link" name="link" value="{{ old('tagline') }}"
                        class="w-full bg-gray-700 text-white border border-gray-600 rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-purple-500 transition duration-300 placeholder-gray-400"
                        placeholder="#k44kc...">
                    @error('tagline')
                        <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
